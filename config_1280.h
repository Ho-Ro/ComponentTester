...
#define LCD_SDI          PB2            /* port pin used for SDI (LCD's data input) */
//#define LCD_SDO          PB3            /* port pin used for SDO (LCD's data output) */
...
#define LCD_SDIN         PB2            /* port pin used for SDIN (LCD's data input) */
...
/*
 *  SSD1306
 *  - I2C interface using hardware SPI
 */
...
#define LCD_SCL          PB1            /* port pin used for SCL */
#define LCD_SI           PB2            /* port pin used for SI (LCD's data input) */
#define LCD_CHAR_X       16             /* characters per line */
#define LCD_CHAR_Y       3              /* number of lines */
#define LCD_EXTENDED_CMD                /* extended instruction set (EXT pin high) */
#define LCD_CONTRAST     32             /* default contrast (0-63) */
...
#define LCD_CS           PB5            /* port pin used for CS (optional) */
#define LCD_SCLK         PB1            /* port pin used for SCLK */
#define LCD_SID          PB2            /* port pin used for SID (LCD's data input) */
#define LCD_DOTS_X       128            /* number of horizontal dots */
#define LCD_DOTS_Y       64             /* number of vertical dots */
...
/* ADC reference selection register bits */
