 ...
 */
  ...
  const unsigned char Probing_str[] MEM_TYPE = "Probíhá mìøení..";
  const unsigned char Timeout_str[] MEM_TYPE = "Vypr¹el èas";
  const unsigned char Failed1_str[] MEM_TYPE = "?®ádná souèátka";
  const unsigned char Failed2_str[] MEM_TYPE = "neznámá - vadná?";
  const unsigned char Done_str[] MEM_TYPE = "hotovo!";
  const unsigned char Select_str[] MEM_TYPE = "Výbìr";
  ...
  const unsigned char Checksum_str[] MEM_TYPE = "Kontrolní souèet";
  ...
  const unsigned char Bye_str[] MEM_TYPE = "Èau...";
  ...
  /* options */
    ...
    const unsigned char Weak_str[] MEM_TYPE = "slabá!";
    const unsigned char Low_str[] MEM_TYPE =  "vybitá!";
  #endif
  ...
  #ifdef SW_SQUAREWAVE
    const unsigned char SquareWave_str[] MEM_TYPE = "Gen. obdélníkù";
  #endif
    ...
    const unsigned char FreqCounter_str[] MEM_TYPE = "Èítaè frekvence";
  #endif
    ...
    const unsigned char EventCounter_str[] MEM_TYPE = "Èítaè událostí";
    const unsigned char Count_str[] MEM_TYPE = "Èítaè";
    const unsigned char Time_str[] MEM_TYPE = "Èas";
    const unsigned char Events_str[] MEM_TYPE = "Události";
  ...
  #ifdef SW_ENCODER
    const unsigned char Encoder_str[] MEM_TYPE = "IRC snímaè";
    const unsigned char TurnRight_str[] MEM_TYPE = "Otoè vpravo!";
  #endif
    ...
    const unsigned char IR_Send_str[] MEM_TYPE = "vysílám...";
  #endif

  #ifdef SW_OPTO_COUPLER
    const unsigned char OptoCoupler_str[] MEM_TYPE = "Optron";
    const unsigned char None_str[] MEM_TYPE = "®ádná";
    ...
    const unsigned char CapLeak_str[] MEM_TYPE = "Cap únik";
    const unsigned char CapCharge_str[] MEM_TYPE = "Nabíjení";
    const unsigned char CapHigh_str[] MEM_TYPE = "Rl";
    const unsigned char CapLow_str[] MEM_TYPE = "Rh";
    const unsigned char CapDischarge_str[] MEM_TYPE = "Vybíjení";
  #endif
