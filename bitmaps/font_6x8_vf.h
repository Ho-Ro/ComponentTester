...
const uint8_t FontData[] PROGMEM = {
  ...
  0xFF,0xD7,0xEF,0xD7,0xFF,0xFF,   /* 0x72 x (reversed color) */
  0x7E,0x42,0x42,0x42,0x42,0x42,   /* 0x73 symbol: battery left side, low */
  0x7E,0x42,0x5A,0x5A,0x5A,0x42,   /* 0x74 symbol: battery left side, high */
  0x42,0x42,0x42,0x42,0x7E,0x18,   /* 0x75 symbol: battery right side, low */
  0x5A,0x5A,0x5A,0x42,0x7E,0x18    /* 0x76 symbol: battery right side, high */
  #endif
};
