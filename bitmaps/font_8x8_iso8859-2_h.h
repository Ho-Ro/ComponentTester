...
const uint8_t FontData[] PROGMEM = {
  ...
  0xBA,0x6C,0xC6,0xC6,0xFE,0xC6,0xC6,0x00,   /* 0x08 Ä (A umlaut) */
  0xBA,0x6C,0xC6,0xC6,0xC6,0x6C,0x38,0x00,   /* 0x09 Ö (O umlaut) */
  0xEE,0xC6,0xC6,0xC6,0xC6,0xC6,0x7C,0x00,   /* 0x0a Ü (U umlaut) */
  0xFC,0xC6,0xC6,0xFC,0xC6,0xC6,0xFC,0xC0,   /* 0x0b ß (sharp s) */
  0x84,0x78,0x0C,0x7C,0xCC,0xCC,0x7A,0x00,   /* 0x0c ä (a umlaut) */
  0x44,0x38,0x6C,0xC6,0xC6,0x6C,0x38,0x00,   /* 0x0d ö (o umlaut) */
  0x28,0xC6,0xC6,0xC6,0xC6,0xCE,0x76,0x00,   /* 0x0e ü (u umlaut) */
  ...
  /* Czech characters */
  0x08,0x10,0x38,0x6C,0xC6,0xFE,0xC6,0x00,   /* 0x6f Á (A with acute) */
  0x08,0x10,0x78,0x0C,0x7C,0xCC,0x7A,0x00,   /* 0x70 á (a with acute) */
  0x08,0x10,0xFE,0xC0,0xDC,0xC0,0xFE,0x00,   /* 0x71 É (E with acute) */
  0x08,0x10,0x7C,0xC6,0xFC,0xC0,0x7C,0x00,   /* 0x72 é (e with acute) */
  0x08,0x10,0x78,0x30,0x30,0x30,0x78,0x00,   /* 0x73 Í (I with acute) */
  0x08,0x10,0x18,0x18,0x18,0x18,0x3C,0x00,   /* 0x74 í (i with acute) */
  0x08,0x10,0x38,0x6c,0xC6,0x6C,0x38,0x00,   /* 0x75 Ó (O with acute) */
  0x08,0x10,0x38,0x44,0x82,0x44,0x38,0x00,   /* 0x76 ó (o with acute) */
  0x08,0x10,0xC6,0xC6,0xC6,0xC6,0x7C,0x00,   /* 0x77 Ú (U with acute) */
  0x08,0x10,0x82,0xC6,0xC6,0xCE,0x76,0x00,   /* 0x78 ú (u with acute) */
  0x08,0x10,0x66,0x24,0x3C,0x18,0x3C,0x00,   /* 0x79 Ý (Y with acute) */
  0x08,0x10,0x86,0xC6,0xCE,0x76,0x06,0x3C,   /* 0x7a ý (y with acute) */
  0x28,0x10,0x7C,0xC6,0xC0,0x66,0x7C,0x00,   /* 0x7b Č (C with caron) */
  0x28,0x10,0x3C,0x66,0xC0,0x66,0x3C,0x00,   /* 0x7c č (c with caron) */
  0x28,0x10,0xF8,0xCC,0xC6,0xCC,0xF8,0x00,   /* 0x7d Ď (D with caron) */
  0x0A,0x0A,0x78,0xCC,0x86,0xCE,0x76,0x00,   /* 0x7e d´ (d with caron) */
  0x28,0x10,0xFE,0xC0,0xFC,0xC0,0xFE,0x00,   /* 0x7f Ě (E with caron) */
  0x28,0x10,0x7C,0xC6,0xFC,0xC0,0x7C,0x00,   /* 0x80 ě (e with caron) */
  0x28,0x10,0xC6,0xF6,0xDE,0xCE,0xC6,0x00,   /* 0x81 Ň (N with caron) */
  0x50,0x20,0xD8,0xEC,0xC6,0xC6,0xC6,0x00,   /* 0x82 ň (n with caron) */
  0x28,0x10,0xFC,0xC6,0xFC,0xD8,0xC6,0x00,   /* 0x83 Ř (R with caron) */
  0x50,0x20,0xDC,0xE6,0xC6,0xC0,0xC0,0x00,   /* 0x84 ř (r with caron) */
  0x28,0x10,0x79,0xC2,0x38,0x86,0xFC,0x00,   /* 0x85 Š (S with caron) */
  0x28,0x10,0x7C,0xC0,0x7C,0x06,0x7C,0x00,   /* 0x86 š (s with caron) */
  0x28,0x10,0x7E,0x18,0x18,0x18,0x18,0x00,   /* 0x87 Ť (T with caron) */
  0x02,0x32,0xFC,0x30,0x30,0x36,0x1C,0x00,   /* 0x88 t' (t with caron) */
  0x10,0x28,0x92,0xC6,0xC6,0xCE,0x76,0x00,   /* 0x89 ů (u with ring above) */
  0x28,0x10,0xFE,0x0E,0x38,0xE0,0xFE,0x00,   /* 0x8a Ž (Z with caron) */
  0x28,0x10,0xFC,0x08,0x30,0x40,0xFC,0x00,   /* 0x8b ž (z with caron) */

  /* additional Polish characters */
  0x38,0x6C,0xC6,0xC6,0xFE,0xC2,0xC4,0x02,   /* 0x8c Ą (A with ogonek) */  
  0x00,0x78,0x0C,0x7C,0xCC,0xCE,0x7C,0x02,   /* 0x8d ą (a with ogonek) */
  0x18,0x7C,0x6E,0xC0,0xC0,0x66,0x3C,0x00,   /* 0x8e Ć (C with caron) */
  0x08,0x10,0x3C,0x66,0xC0,0x66,0x3C,0x00,   /* 0x8f ć (c with caron) */
  0xFE,0xC0,0xFC,0xC0,0xC0,0xFE,0x04,0x02,   /* 0x90 Ę (E with ogonek) */
  0x00,0x7C,0xC6,0xFE,0xC0,0xC6,0x7C,0x02,   /* 0x91 ę (e with ogonek) */
  0x60,0x60,0x70,0xE0,0x60,0x60,0x7E,0x00,   /* 0x92 Ł (L with stroke) */
  0x38,0x18,0x1C,0x38,0x18,0x18,0x18,0x00,   /* 0x93 ł (l with stroke) */
  0x08,0x10,0xC6,0xF6,0xDE,0xCE,0xC6,0x00,   /* 0x94 Ń (N with acute) */
  0x08,0x10,0xD8,0xEC,0xC6,0xC6,0xC6,0x00,   /* 0x95 ń (n with acute) */
  0x08,0x10,0x7E,0xC2,0x38,0x86,0xFC,0x00,   /* 0x96 Ś (S with acute) */
  0x08,0x10,0x7C,0xC0,0x7C,0x06,0x7C,0x00,   /* 0x97 ś (s with acute) */
  0x08,0x10,0xFE,0x0E,0x38,0xE0,0xFE,0x00,   /* 0x98 Ź (Z with acute) */
  0x08,0x10,0xFC,0x08,0x30,0x40,0xFC,0x00,   /* 0x99 ź (z with acute) */
  0x08,0xFE,0x06,0x1C,0x38,0xE0,0xFE,0x00,   /* 0x9a Ż (Z with dot above) */
  0x10,0x00,0xFC,0x08,0x30,0x40,0xFC,0x00,   /* 0x9b ż (z with dot above) */

  /* additional Romanian characters */
  0x38,0x44,0x10,0x6C,0xC6,0xFE,0xC6,0x00,   /* 0x9c Â (A with circumflex) */  
  0x3C,0x42,0x18,0x0C,0x7C,0xCC,0x7A,0x00,   /* 0x9d â (a with circumflex) */
  0x28,0x10,0x10,0x6C,0xC6,0xFE,0xC6,0x00,   /* 0x9e Ă (A with breve) */  
  0x28,0x10,0x78,0x0C,0x7C,0xCC,0x7A,0x00,   /* 0x9f ă (a with breve) */
  0x18,0x24,0x3C,0x18,0x18,0x18,0x3C,0x00,   /* 0xa0 Î (I with circumflex) */
  0x18,0x24,0x00,0x38,0x18,0x18,0x3C,0x00,   /* 0xa1 î (i with circumflex) */
  0x7C,0xc6,0xC0,0x7C,0x06,0xFE,0x20,0xC0,   /* 0xa2 Ş (S with cedilla) */
  0x00,0x7C,0xC0,0x7C,0x06,0x7C,0x10,0x60,   /* 0xa3 ş (s with cedilla) */
  0x7E,0x18,0x18,0x18,0x18,0x10,0x08,0x30,   /* 0xa4 Ţ (T with cedilla) */
  0x30,0x30,0xFC,0x30,0x30,0x30,0x1C,0x60,   /* 0xa5 ţ (t with cedilla) */ 

  /* additional Hungarian characters */
  0x28,0x28,0x10,0x28,0x6C,0x6C,0x38,0x00,   /* 0xa6 Ő (O with double acute) */
  0x28,0x28,0x10,0x6C,0xC6,0x6C,0x38,0x00,   /* 0xa7 ő (o with double acute) */
  0x28,0xAA,0x82,0xC6,0xC6,0xC6,0x7C,0x00,   /* 0xa8 Ű (U with double acute) */
  0x28,0x28,0x82,0xC6,0xC6,0xCE,0x76,0x00,   /* 0xa9 ű (u with double acute) */

  /* additional Serbo-Croatian characters */
  0x78,0x6C,0x66,0xF6,0x66,0x6C,0x78,0x00,   /* 0xaa Đ (D with stroke) */
  0x06,0x76,0xCE,0xC6,0xCF,0xC6,0x7E,0x00,   /* 0xab đ (d with stroke) */

  /* additional Albanian characters */
  0x3C,0x66,0xC0,0xC0,0xC0,0x66,0x3C,0xC0,   /* 0xac Ç (C with cedilla) */
  0x00,0x3C,0x66,0xC0,0xC0,0x66,0x3C,0xC0    /* 0xad ç (c with cedilla) */
  #ifdef FONT_EXTRA
  ,

  /* extra characters */
  0xCF,0x8F,0xCF,0xCF,0xCF,0xCF,0x87,0xFF,   /* 0xae 1 (reversed color) */
  0x83,0x39,0xF9,0xE3,0x8F,0x3F,0x01,0xFF,   /* 0xaf 2 (reversed color) */
  0x83,0x39,0xF9,0xE7,0xF9,0x39,0x83,0xFF,   /* 0xb0 3 (reversed color) */#
  0xFF,0xFF,0xBB,0xD7,0xEF,0xD7,0xBB,0xFF,   /* 0xb1 x (reversed color) */
  0x00,0xFF,0x80,0x80,0x80,0x80,0xFF,0x00,   /* 0xb2 symbol: battery left side, low */
  0x00,0xFF,0x80,0xBE,0xBE,0x80,0xFF,0x00,   /* 0xb3 symbol: battery left side, high */
  0x00,0xFE,0x02,0x03,0x03,0x02,0xFE,0x00,   /* 0xb4 symbol: battery right side, low */
  0x00,0xFE,0x02,0xFB,0xFB,0x02,0xFE,0x00    /* 0xb5 symbol: battery right side, high */
  #endif
};
...
const uint8_t FontTable[] PROGMEM = {
  ...
  0x04,        /* 0x04 -> omega (or built-in 0x1e) */
  0x05,        /* 0x05 -> µ (micro) */
