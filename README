...
------------------------------------------------------------------------------
        ...
        (c) 2012-2023 by Markus Reschke (madires@theca-tabellaria.de)
...
instead of LCD_ST7735) with the same settings.
...
a completed probing cycle (UI_PROBING_DONE_BEEP).
...
- The capacitance values for electrolytic caps can be a bit lower than in
  the normal probing cycle (reason still unknown).
...
press changes the mode back again. And as you already guessed, two short
